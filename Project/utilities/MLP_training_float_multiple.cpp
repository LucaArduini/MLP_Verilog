...
//
// These statistics will be compared against the results from a similar fixed-point
// training script. This comparison helps us choose the most reliable training
// approach to generate the final weights for hardware inference.
