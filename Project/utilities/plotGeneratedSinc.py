# This Python script is a simple visualization tool. It reads the output
# data generated by the C++ program ("inference_grid_results.txt") and
# creates two 3D plots.
#
# The first plot shows the surface of the function our MLP learned, while
# the second shows the surface of the true, ideal function.
#
# Comparing these two plots side-by-side provides a quick, visual way to
# check how well our network's predictions match the ground truth.
