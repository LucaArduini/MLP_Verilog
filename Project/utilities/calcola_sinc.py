# Python script that computes the two-dimensional sinc function.
# It was used to easily obtain some reference values of the sinc function, 
# later compared with those generated by the MLP network.
