...
x_val4 = 0.0
y_val4 = 0.0
risultato4 = sinc2D_modified(x_val4, y_val4)
...
for i, (x_val, y_val) in enumerate(test_data_pairs):
  risultato = sinc2D_modified(x_val, y_val)
